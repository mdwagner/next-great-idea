...
export const validationSchema = yup.object({
  ...
  FUSIONAUTH_API_KEY: yup
    .string()
    .default('bf69486b-4733-4470-a592-f1bfce7af580'),
  FUSIONAUTH_TENANT_ID: yup
    .string()
    .default('ec02c5c8-d4ef-440e-b5ff-5f3b4fe51b48'),
  FUSIONAUTH_APP_ID: yup
    .string()
    .default('85a03867-dccf-4882-adde-1a79aeec50df'),
  FUSIONAUTH_THEME_ID: yup
    .string()
    .default('d2c5b616-cdb7-4abb-97cc-4465a29f313f'),
  FUSIONAUTH_JWT_KEY_ID: yup
    .string()
    .default('29c14b28-fe3a-4db5-a49c-3fd30b5e4bce'),
  FUSIONAUTH_EMAIL_TEMPLATE_VERIFICATION_ID: yup
    .string()
    .default('6e046c92-5a42-4d21-8bb8-8e76eba035c7'),
